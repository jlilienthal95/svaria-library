...
<div id='docs' style='margin-bottom: 35% ; margin-top:2%; font-size: 1.25em; line-height:1.6'>
    ...
    <div class="pt-4 rounded-lg sm:rounded-xl leading-[21px] relative z-10 flex w-3/4 max-h-[inherit] text-m text-black dark:text-white border border-black/[15%] ml-auto mr-auto dark:border-gray-650 bg-black dark:bg-gray-850"><code class="w-full grid h-9"><div class="px-4 pr-14 sm:pl-[26px] block dark:hidden"><span class="" style="color: rgb(121, 94, 38);">npm</span><span class="" style="color: rgb(0, 0, 0);"> </span><span class="" style="color: rgb(163, 21, 21);">install</span><span class="" style="color: rgb(0, 0, 0);"> </span><span class="" style="color: rgb(163, 21, 21);">svaria-toolkit</span>
    </div><div class="px-4 pr-14 sm:pl-[26px] hidden dark:block"><span class="" style="color: rgb(220, 220, 170);">npm </span><span class="" style="color: rgb(212, 212, 212);"> </span><span class="" style="color: rgb(206, 145, 120);">install </span><span class="" style="color: rgb(212, 212, 212);"> </span><span class="" style="color: rgb(206, 145, 120);">svaria-toolkit</span>
    </div>
